    ...
    <div class="row panel-default-padding">
		...
		<div class="col-md-12">
			...
			<div class="info-doctor__content">
				...
				<div class="col-md-4">
					<h3>
						Phone Number <label>{{ $doctor['entity']['contact'] }}</label>
					</h3>
					<h3>
						Address <label>{{ $doctor['entity']['address'] }} , {{ $doctor['entity']['city']['name'] }}, {{ $doctor['entity']['city']['province']['name'] }}, {{ $doctor['entity']['city']['province']['country']['name'] }}</label>
					</h3>
				</div>
				<div class="col-md-4">
					 <table>
