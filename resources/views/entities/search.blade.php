					...
					<div>
						...
						@if($collection->all())
							<div class="dropdown dropdown-custom">
								<h3>Filter</h3>
								<button class="btn btn-primary btn-sm dropdown-toggle hover-custom-dropdown" type="button" data-toggle="dropdown">choose
                    ...
                    <div class="[ row text-center]">
                        ...
                        @else
                            <div class="text-center">
                                <h1>:'(</h1>
                                <p><a href="{{ route('guest.entity.search') }}">See All Doctors<i class="fa fa-arrow-right"></i></a></p>
                            </div>
                        @endif
                    </div>
                </div>
